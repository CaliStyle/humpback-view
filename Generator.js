...
module.exports = {
  ...
  before: function (scope, cb) {
    ...
    if (!scope.args[0]) {
      return cb( new Error('Please provide a name for this humpback-view.') );
    }
...
function INVALID_SCOPE_VARIABLE (varname, details, message) {
  var DEFAULT_MESSAGE =
  'Issue encountered in generator "humpback-view":\n'+
  'Missing required scope variable: `%s`"\n' +
  'If you are the author of `sails-generate-humpback-view`, please resolve this '+
